        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-rose-100">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-800">Fix vs. Variabel</h3>
                        <p className="text-xs text-gray-400">Flexibilität des Budgets</p>
                    </div>
                </div>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-rose-100">
                <h3 className="font-bold text-gray-800 mb-4">Top 5 Ausgaben</h3>
                <div className="space-y-3">
                    {topCatsData.map((cat, idx) => (
                        <div key={idx} className="space-y-1">
                            <div className="flex justify-between text-sm">
                                <span className="font-medium text-gray-700">{idx + 1}. {cat.name}</span>
                                <span className="font-bold text-gray-900">€{Number(cat.value).toFixed(2)}</span>
                            </div>
