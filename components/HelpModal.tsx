...
export default function HelpModal({ onClose }: { onClose: () => void }) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl h-[85vh] flex flex-col font-['Patrick_Hand'] overflow-hidden relative">

                {/* Header */}
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-white z-10">
                    <div>
                        <h2 className="text-2xl font-bold">Wie die App "denkt" 🧠</h2>
                        <p className="text-gray-500 text-sm">Die 4 Säulen deiner Finanz-Intelligenz</p>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-10">
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="pl-10 space-y-2 text-gray-600">
                            <p>Jährliche Boni oder Dividenden verfälschen oft die Monatsstatistik. Wir machen es anders:</p>
                            <div className="bg-gray-50 p-3 rounded-xl border border-dashed border-gray-200 flex items-center gap-4 text-sm">
                                <span className="font-mono bg-white px-2 py-1 rounded border">1200€ Jährlich</span>
                                <Divide className="w-4 h-4 text-gray-400" />
                                <span className="font-mono bg-white px-2 py-1 rounded border">12 Monate</span>
                                <span>=</span>
                                <span className="font-bold text-emerald-600">100€ / Monat</span>
                            </div>
                    ...
                    <section className="space-y-3">
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center font-bold">2</div>
                            <h3 className="text-xl font-bold">Intelligente Fixkosten</h3>
                        </div>
                        <div className="pl-10 space-y-2 text-gray-600">
                            <p>Miete, Netflix, Versicherungen... Die App beachtet das <strong className="text-black">Enddatum</strong>.</p>
                            <div className="flex gap-2 items-center text-sm bg-rose-50 p-2 rounded-lg inline-block">
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="pl-10 space-y-4 text-gray-600">
                            ...
                            <div className="border border-purple-100 rounded-xl p-3">
                                <h4 className="font-bold text-purple-600 flex items-center gap-2 mb-1">
                    ...
                    <section className="space-y-3">
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center font-bold">4</div>
...
04.02.2026 -45,00 EUR Tankstelle`}
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <section className="bg-indigo-50 p-4 rounded-xl space-y-2">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold">5</div>
                        ...
                        <section className="bg-amber-50 p-4 rounded-xl space-y-2">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="w-8 h-8 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center font-bold">6</div>
                    ...
                    {/* Bottom Line */}
                    <div className="bg-gradient-to-r from-gray-100 to-gray-50 p-4 rounded-xl text-center mt-6">
                ...
                <div className="p-4 border-t border-gray-100 bg-white">
                    <button
                        onClick={onClose}
                        className="w-full py-3 bg-black text-white rounded-xl font-bold text-lg hover:opacity-90 active:scale-95 transition-all"
                    >
